...
export default function Home() {
  ...
  const waterSaved = eco ? Math.round(eco.water_saved_liters) + 'L' : '0L';
  const co2Saved = eco ? fmt(eco.co2_reduced_kg, 1) + 'kg' : '0.0kg';
          ...
          >
            ...
            <div className="relative">
              ...
              <div className="grid grid-cols-3 gap-8">
                ...
                <div>
                  <p className="text-4xl font-bold text-white">{waterSaved}</p>
                  <div className="flex items-center gap-1.5 mt-2">
                    <svg className="w-3.5 h-3.5 text-green-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2}
                ...
                <div>
                  <p className="text-4xl font-bold text-white">{co2Saved}</p>
                  <div className="flex items-center gap-1.5 mt-2">
                    <svg className="w-3.5 h-3.5 text-green-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2}
