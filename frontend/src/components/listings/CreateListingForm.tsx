...
export default function CreateListingForm() {
  ...
  const handleCalculatePricing = async () => {
    ...
    try {
      ...
      setValue('final_price', data.final_price);
      setValue('delivery_cost', data.delivery_cost);
      setValue('platform_commission', data.platform_commission);
      setValue('payment_fees', data.payment_fees);
      setValue('seller_payout', data.seller_payout);
  ...
  const onSubmit = async (data: FormData) => {
    ...
    try {
      ...
      // Redirect to seller portal or listing detail page
  ...
  const renderStep1 = () => (
    <div>
      <h2 className="text-2xl font-bold mb-4">Step 1: Scan Your Book</h2>
  ...
  const renderStep2 = () => (
    <div>
      <h2 className="text-2xl font-bold mb-4">Step 2: Book Details</h2>
      <p className="text-gray-600 mb-6">
  ...
  const renderStep3 = () => (
    <div>
      <h2 className="text-2xl font-bold mb-4">Step 3: Review Condition & Pricing</h2>
      <p className="text-gray-600 mb-6">
      ...
      <div className="space-y-6">
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-6">
          <h3 className="text-lg font-bold mb-4">Condition Assessment</h3>
  ...
  const renderStep4 = () => (
    <div>
      <h2 className="text-2xl font-bold mb-4">Step 4: Confirm & Submit</h2>
      <p className="text-gray-600 mb-6">
      ...
      <div className="space-y-6">
        {/* Summary */}
        <div className="bg-white rounded-lg border border-gray-200 p-6">
          <h3 className="text-lg font-bold mb-4">Listing Summary</h3>
          ...
          <div className="space-y-3">
            ...
            <div>
              ...
              <p className="font-medium">{watch('author')}</p>
            </div>
            <div>
    ...
    <div className="max-w-4xl mx-auto p-6">
      ...
      <div className="mb-8">
        ...
        <div className="flex justify-between mt-2 text-sm">
          <span className={currentStep === 1 ? 'font-medium' : 'text-gray-500'}>Scan</span>
          ...
          <span className={currentStep === 4 ? 'font-medium' : 'text-gray-500'}>Confirm</span>
        </div>
      </div>
